...
from studentmanagementapp import views, HodViews, StaffViews, StudentViews
from studentmanagementapp.EditResultViewClass import EditResultViewClass
...
urlpatterns = [
    ...
    path('staff_feedback_save', StaffViews.staff_apply_leave, name="staff_feedback_save"),
    ...
    path('student_feedback_save', StudentViews.student_apply_leave, name="student_feedback_save"),
